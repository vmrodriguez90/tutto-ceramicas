...
<div class="js-shipping-suboption shipping-suboption {{suboptions.name}}">
    {% if suboptions.options %}
        ...
        <a href="#{{ modal_id_val }}" data-toggle="modal" class="js-trigger-modal-zindex-top btn-link btn-block">
            ...
            <span class="align-middle">{{ 'Ver direcciones' | translate }}</span>
        </a>

        <div id="{{ modal_id_val }}" class="js-modal-shipping-suboptions js-modal-xs-centered modal modal-xs modal-xs-centered hide fade modal-zindex-top" tabindex="-1" role="dialog" aria-hidden="true">
