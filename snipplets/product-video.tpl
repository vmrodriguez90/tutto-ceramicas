{% if product.video_url %}
    ...
    {% else %}
		...
		<div class="{% if not thumb %}js-product-slide js-product-video-slide slider-slide{% endif %} swiper-slide" {% if not thumb %}data-image-position="{{ video_index }}"{% endif %}>

			{% if thumb %}
				<a href="#" class="js-product-thumb js-video-thumb product-thumb" data-slide-index="{{ video_index }}">
