...
<div class="js-product-slider-placeholder mobile-placeholder product-placeholder-container placeholder-container {% if product.images_count == 1 %}hidden-when-content-ready{% endif %}">
    ...
    <div class="placeholder-icon">
        {% include "snipplets/svg/images.tpl" %}
    </div>
